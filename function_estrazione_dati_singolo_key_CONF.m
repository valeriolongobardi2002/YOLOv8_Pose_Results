function [CONFIDENCE, keypoints_PRED, keypoints_TRUE, missed_detection, false_detection] = function_estrazione_dati_singolo_key_CONF(folderPath_predictions, folderPath_true, conf_treshold)
