...
hold on;
h3x_r = plot(1, media_x(1, 3), '-r', 'MarkerSize', 6); 
hold on;
...
hold on;
h3y_r = plot(1, media_y(1, 3), '-r', 'MarkerSize', 6); 
hold on;
...
for k = 2900:3680
    ...
    set(h3x_r, 'XData', x_min:x_max, 'YData', media_x(x_min:k, 3));
    ...
    set(h3y_r, 'XData', x_min:x_max, 'YData', media_y(x_min:k, 3));
    ...
    ylim(subplot(3, 2, 5), [ymin ymax+5]);
