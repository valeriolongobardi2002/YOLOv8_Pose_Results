function [CONFIDENCE, keypoints_PRED, keypoints_TRUE, missed_detection, false_detection] = function_estrazione_dati_singolo_key(folderPath_predictions, folderPath_true)
